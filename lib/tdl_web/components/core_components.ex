defmodule TdlWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: TdlWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TdlWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TdlWeb.Gettext, "errors", msg, opts)
    end
  end
